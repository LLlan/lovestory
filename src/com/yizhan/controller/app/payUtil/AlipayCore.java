...
public class AlipayCore {
     ...
     * @throws Exception 
     */
    public static void logResult(String sWord,String filename) throws Exception {
        FileWriter writer = null;
        //创建一个文件夹
        FileUtil.createDir(AlipayConfig.log_path);
        try {
            writer = new FileWriter(AlipayConfig.log_path + "alipay_log_" +filename+DateUtil.getTimes()+".txt");
            writer.write(sWord);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
