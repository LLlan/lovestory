package com.yizhan.service.system.role;
...
public class RoleService{
	...
	public List<Role> listRoles() throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.listRoles", null);
		
	}
	
	//列出所有一级角色下的所有子角色
	public List<Role> listRoleByParentId(String parentId)throws Exception{
		return (List<Role>)dao.findForList("RoleMapper.listRoleByParentId", parentId);
	}
