...
<div class="big_box" style="margin-bottom: 15px;margin-top: 57px;">
    ...
    <div class="weui-tab">
        <div class="weui-navbar">
            ...
            <a class="weui-navbar__item weui-bar__item--on" onclick="window.location.href='api/member/index.do?type=2'">
                女会员
            </a>
            ...
            <a class="weui-navbar__item" onclick="window.location.href='api/member/index.do?type=4'">
                夕阳红
            </a>
        </div>
