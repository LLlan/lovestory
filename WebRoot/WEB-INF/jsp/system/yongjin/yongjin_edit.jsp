...
<body>
	<form action="yongJin/${msg }.do" method="post" id="Form">
		<input type="hidden" name="yongjin_id" value="${pd.yongjin_id}"/>
		<div id="zhongxin">
		<table style="margin: 15px 0 0 25px;">
			<tr class="info">
				<td>佣金额:</td>
				<td>
					<input type="text" name="yongjin" id="yongjin" placeholder="输入佣金额" value="${pd.yongjin }"/>
				</td>
			</tr>
