...
<body>
	<form action="memberCost/${msg }.do" method="post" id="Form">
		<input type="hidden" name="member_cost_id" value="${pd.member_cost_id}"/>
		<div id="zhongxin">
		<table style="margin: 15px 0 0 25px;">
			<tr class="info">
				<td>费用:</td>
				<td>
					<input type="text" name="cost" id="cost" placeholder="输入会员费用" value="${pd.cost }"/>
				</td>
			</tr>
